...
// Valid indicates whether the value is a known member of the CollectionSortDirection enum.
func (e CollectionSortDirection) Valid() bool {
	switch e {
	case Asc:
		return true
	case Desc:
...
// Valid indicates whether the value is a known member of the FileOperationState enum.
func (e FileOperationState) Valid() bool {
	switch e {
	case FileOperationStateComplete:
		return true
	case FileOperationStateCreating:
		return true
	case FileOperationStateError:
		return true
	case FileOperationStateExpired:
		return true
	case FileOperationStateUploading:
		return true
	default:
		return false
	}
...
const (
	Export FileOperationType = "export"
	Import FileOperationType = "import"
)

// Valid indicates whether the value is a known member of the FileOperationType enum.
func (e FileOperationType) Valid() bool {
	switch e {
	case Export:
		return true
	case Import:
...
const (
	...
	InviteRoleGuest  InviteRole = "guest"
...
// Valid indicates whether the value is a known member of the SortingDirection enum.
func (e SortingDirection) Valid() bool {
	switch e {
	case ASC:
		return true
	case DESC:
...
// Defines values for TeamDefaultUserRole.
const (
	TeamDefaultUserRoleAdmin  TeamDefaultUserRole = "admin"
	TeamDefaultUserRoleMember TeamDefaultUserRole = "member"
	TeamDefaultUserRoleViewer TeamDefaultUserRole = "viewer"
)

// Valid indicates whether the value is a known member of the TeamDefaultUserRole enum.
func (e TeamDefaultUserRole) Valid() bool {
	switch e {
	case TeamDefaultUserRoleAdmin:
		return true
	case TeamDefaultUserRoleMember:
		return true
	case TeamDefaultUserRoleViewer:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PostCollectionsExportJSONBodyFormat enum.
func (e PostCollectionsExportJSONBodyFormat) Valid() bool {
	switch e {
	case PostCollectionsExportJSONBodyFormatHtml:
		return true
	case PostCollectionsExportJSONBodyFormatJson:
		return true
	case PostCollectionsExportJSONBodyFormatOutlineMarkdown:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PostCollectionsExportAllJSONBodyFormat enum.
func (e PostCollectionsExportAllJSONBodyFormat) Valid() bool {
	switch e {
	case PostCollectionsExportAllJSONBodyFormatHtml:
		return true
	case PostCollectionsExportAllJSONBodyFormatJson:
		return true
	case PostCollectionsExportAllJSONBodyFormatOutlineMarkdown:
		return true
	default:
		return false
	}
...
// Defines values for PostUsersDemoteJSONBodyTo.
const (
	Member PostUsersDemoteJSONBodyTo = "member"
	Viewer PostUsersDemoteJSONBodyTo = "viewer"
)

// Valid indicates whether the value is a known member of the PostUsersDemoteJSONBodyTo enum.
func (e PostUsersDemoteJSONBodyTo) Valid() bool {
	switch e {
	case Member:
		return true
	case Viewer:
...
type FileOperation struct {
	Collection *struct {
		...
		// Embedded struct due to allOf(#/components/schemas/Collection)
...
type Team struct {
	...
	DefaultUserRole *TeamDefaultUserRole `json:"defaultUserRole,omitempty"`
...
// TeamDefaultUserRole If set then this role will be used as the default for users that signup via SSO
type TeamDefaultUserRole string
...
type PostDocumentsDraftsJSONBody struct {
	// Embedded struct due to allOf(#/components/schemas/Pagination)
	Pagination `yaml:",inline"`
	// Embedded struct due to allOf(#/components/schemas/Sorting)
	Sorting `yaml:",inline"`
	// Embedded fields due to inline allOf schema
...
// PostUsersDemoteJSONBody defines parameters for PostUsersDemote.
type PostUsersDemoteJSONBody struct {
	// Id Unique identifier for the user.
	Id openapi_types.UUID `json:"id"`

	// To Which role to demote to
	To *PostUsersDemoteJSONBodyTo `json:"to,omitempty"`
}

// PostUsersDemoteJSONBodyTo defines parameters for PostUsersDemote.
type PostUsersDemoteJSONBodyTo string
...
// PostUsersPromoteJSONBody defines parameters for PostUsersPromote.
type PostUsersPromoteJSONBody struct {
	// Id Unique identifier for the user.
	Id openapi_types.UUID `json:"id"`
}
...
// PostUsersDemoteJSONRequestBody defines body for PostUsersDemote for application/json ContentType.
type PostUsersDemoteJSONRequestBody PostUsersDemoteJSONBody
...
// PostUsersPromoteJSONRequestBody defines body for PostUsersPromote for application/json ContentType.
type PostUsersPromoteJSONRequestBody PostUsersPromoteJSONBody
...
type ClientInterface interface {
	...
	// PostUsersDemoteWithBody request with any body
	PostUsersDemoteWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostUsersDemote(ctx context.Context, body PostUsersDemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// PostUsersPromoteWithBody request with any body
	PostUsersPromoteWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostUsersPromote(ctx context.Context, body PostUsersPromoteJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PostUsersDemoteWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostUsersDemoteRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostUsersDemote(ctx context.Context, body PostUsersDemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostUsersDemoteRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostUsersPromoteWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostUsersPromoteRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostUsersPromote(ctx context.Context, body PostUsersPromoteJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostUsersPromoteRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostUsersDemoteRequest calls the generic PostUsersDemote builder with application/json body
func NewPostUsersDemoteRequest(server string, body PostUsersDemoteJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostUsersDemoteRequestWithBody(server, "application/json", bodyReader)
}

// NewPostUsersDemoteRequestWithBody generates requests for PostUsersDemote with any type of body
func NewPostUsersDemoteRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/users.demote")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewPostUsersPromoteRequest calls the generic PostUsersPromote builder with application/json body
func NewPostUsersPromoteRequest(server string, body PostUsersPromoteJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostUsersPromoteRequestWithBody(server, "application/json", bodyReader)
}

// NewPostUsersPromoteRequestWithBody generates requests for PostUsersPromote with any type of body
func NewPostUsersPromoteRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/users.promote")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostUsersDemoteWithBodyWithResponse request with any body
	PostUsersDemoteWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostUsersDemoteResponse, error)

	PostUsersDemoteWithResponse(ctx context.Context, body PostUsersDemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*PostUsersDemoteResponse, error)
	...
	// PostUsersPromoteWithBodyWithResponse request with any body
	PostUsersPromoteWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostUsersPromoteResponse, error)

	PostUsersPromoteWithResponse(ctx context.Context, body PostUsersPromoteJSONRequestBody, reqEditors ...RequestEditorFn) (*PostUsersPromoteResponse, error)
...
type PostUsersDemoteResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		Data *User `json:"data,omitempty"`
...
// Status returns HTTPResponse.Status
func (r PostUsersDemoteResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostUsersDemoteResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PostUsersPromoteResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		Data *User `json:"data,omitempty"`
...
// Status returns HTTPResponse.Status
func (r PostUsersPromoteResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostUsersPromoteResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PostUsersDemoteWithBodyWithResponse request with arbitrary body returning *PostUsersDemoteResponse
func (c *ClientWithResponses) PostUsersDemoteWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostUsersDemoteResponse, error) {
	rsp, err := c.PostUsersDemoteWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostUsersDemoteResponse(rsp)
}

func (c *ClientWithResponses) PostUsersDemoteWithResponse(ctx context.Context, body PostUsersDemoteJSONRequestBody, reqEditors ...RequestEditorFn) (*PostUsersDemoteResponse, error) {
	rsp, err := c.PostUsersDemote(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostUsersDemoteResponse(rsp)
...
// PostUsersPromoteWithBodyWithResponse request with arbitrary body returning *PostUsersPromoteResponse
func (c *ClientWithResponses) PostUsersPromoteWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostUsersPromoteResponse, error) {
	rsp, err := c.PostUsersPromoteWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostUsersPromoteResponse(rsp)
}

func (c *ClientWithResponses) PostUsersPromoteWithResponse(ctx context.Context, body PostUsersPromoteJSONRequestBody, reqEditors ...RequestEditorFn) (*PostUsersPromoteResponse, error) {
	rsp, err := c.PostUsersPromote(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostUsersPromoteResponse(rsp)
...
// ParsePostUsersDemoteResponse parses an HTTP response from a PostUsersDemoteWithResponse call
func ParsePostUsersDemoteResponse(rsp *http.Response) (*PostUsersDemoteResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostUsersDemoteResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParsePostUsersPromoteResponse parses an HTTP response from a PostUsersPromoteWithResponse call
func ParsePostUsersPromoteResponse(rsp *http.Response) (*PostUsersPromoteResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostUsersPromoteResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
